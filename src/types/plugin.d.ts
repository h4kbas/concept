 ...
 */
export type ConceptEventType = 'concept:added' | 'concept:updated' | 'pair:added' | 'pair:updated' | 'data:added' | 'data:updated' | 'inference:completed' | 'block:state:changed';
/**
...
export interface ConceptPlugin {
     ...
     */
    getHooks?(block?: any): Record<string, (params: Concept[], block?: Concept[]) => Concept[] | void>;
}
/**
...
export interface PluginManager {
     ...
     */
    registerListener(eventType: ConceptEventType, listener: ConceptListener): void;
    /**
     * Unregister a concept listener
     */
    unregisterListener(eventType: ConceptEventType, listener: ConceptListener): void;
    /**
